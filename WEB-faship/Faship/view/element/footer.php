    ...
    <div class="container">
        <div class="row row-pb-md">
            <div class="col-4 footer-col colorlib-widget ">
                ...
                Số điện thoại: 0367520224</p>
                <p class="text-white fs-6 mb-0"><i class="fa-solid fa-envelope"></i>
                Email: fashipcskh@gmail.vn</p>
                <p class="text-white fs-6"><i class="fa-solid fa-location-dot"></i> 
                Địa chỉ cửa hàng: 41A, Đường Phú Diễn, Quận Bắc Từ Liêm, Thành Phố Hà Nội</p>
                <P class="text-white">© Bản quyền thuộc về <span class="text-primary">Faship</span>| Cung cấp bởi <span class="text-primary">Wish</span> </P>
            ...
            <div class="col-3 footer-col colorlib-widget">
                ...
                <ul class="colorlib-footer-links">
                    ...
                    <li><a href="#" class="text-white fs-7">Chính sách bảo mật</a></li>
                    <li><a href="#" class="text-white fs-7">Quy định sử dụng</a></li>
                </ul>
                </p>
            </div>
            <div class="col-3 footer-col colorlib-widget">
                <h4 class="text-white fs-5">Hỗ trợ</h4>
                <p>
                <ul class="colorlib-footer-links">
                    <li><a href="#" class="text-white fs-7">Giao hàng - thanh toán</a></li>
                    <li><a href="#" class="text-white fs-7">Đổi size - bảo hành</a></li>
                    <li><a href="#" class="text-white fs-7">Hướng dẫn lựa chọn size</a></li>
                    <li><a href="#" class="text-white fs-7">Ưu đãi thành viên</a></li>
                </ul>
                </p>
            </div>
