        ...
        <div class="row row-pb-lg">
            <div class="col-md-12">
                ...
                <?php if (isset($_SESSION['cart_product'])) {
                    $subtotal = 0;// khởi tạo biến để tính tổng giá trị trong giỏ hàng

                    $dem = 0;//Khởi tạo biến $dem để đếm tổng số lượng sản phẩm trong giỏ hàng.
                    // Sử dụng vòng lặp foreach để duyệt qua từng sản phẩm trong giỏ hàng.
                    //và lấy tt chi tiết sản phẩm qua mã sp
                ...
                <div class="total-wrap">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-center    ">
                            <div class="total">
                                <div class="sub">
                                <!-- Hiển thị tạm tính (tổng giá trị của sản phẩm trong giỏ hàng),  -->
