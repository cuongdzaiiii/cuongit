                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-sm-12 col-xs-12  pt-5">
                                ...
                                placeholder="password"> <span class="ac" id="forgot">Quên?</span>
                                    ...
                                    <div class="loginkhac">
                                    <button class="gmail"><a href="../admin" style="text-decoration: none; color: black;">Admin</a></button>
